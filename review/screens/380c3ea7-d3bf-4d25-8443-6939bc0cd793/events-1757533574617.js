jQuery("#simulation")
  .on("click", ".s-380c3ea7-d3bf-4d25-8443-6939bc0cd793 .click", function(event, data) {
  ...
  .on("mouseenter dragenter", ".s-380c3ea7-d3bf-4d25-8443-6939bc0cd793 .mouseenter", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
              ...
              "actions": [
                {
                  ...
                  "parameter": [ {
                    "target": [ "#s-380c3ea7-d3bf-4d25-8443-6939bc0cd793 #s-Image_1 svg" ],
                    "attributes": {
                    ...
                    "target": [ "#s-380c3ea7-d3bf-4d25-8443-6939bc0cd793 #s-Image_1" ],
                    "attributes": {
              ...
              "actions": [
                {
                  "action": "jimChangeStyle",
                  "parameter": [ {
                    "target": [ "#s-380c3ea7-d3bf-4d25-8443-6939bc0cd793 #s-Text_1 span" ],
                    "attributes": {
                      "color": "#000000",
              ...
              "actions": [
                {
                  "action": "jimChangeStyle",
                  "parameter": [ {
                    "target": [ "#s-380c3ea7-d3bf-4d25-8443-6939bc0cd793 #s-Text_2 span" ],
                    "attributes": {
                      "color": "#000000",
                      "text-decoration": "underline"
                    }
              ...
              "actions": [
                {
                  "action": "jimChangeStyle",
                  "parameter": [ {
                    "target": [ "#s-380c3ea7-d3bf-4d25-8443-6939bc0cd793 #s-Text_3 span" ],
                    "attributes": {
                      "color": "#000000",
                      "text-decoration": "underline"
                    }
              ...
              "actions": [
                {
                  "action": "jimChangeStyle",
                  "parameter": [ {
                    "target": [ "#s-380c3ea7-d3bf-4d25-8443-6939bc0cd793 #s-Text_4 span" ],
                    "attributes": {
                      "color": "#000000",
                      "text-decoration": "underline"
                    }
              ...
              "actions": [
                {
                  "action": "jimChangeStyle",
                  "parameter": [ {
                    "target": [ "#s-380c3ea7-d3bf-4d25-8443-6939bc0cd793 #s-Text_5 span" ],
                    "attributes": {
                      "color": "#000000",
                      "text-decoration": "underline"
                    }
  ...
  .on("mouseleave dragleave", ".s-380c3ea7-d3bf-4d25-8443-6939bc0cd793 .mouseleave", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
